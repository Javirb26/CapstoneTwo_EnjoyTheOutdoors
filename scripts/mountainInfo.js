// Provide drop down list of the 48 mountains in array
// when user selects a mountain you display information about that mountain
// Mountain name - Description - elevation  - any other interesting info


window.onload = function populateMountainSelect () {
    // Select Element to be Populated
    ...
    const descriptionEl = document.getElementById("description");
        ...
        // Function to populate mountainSelect with the park names
        let populateSelect = (selectEl, array) => {
             for(let i = 0; i < array.length; i++){
                let optionData = array[i].name;
                let optionEl = new Option(optionData);
                selectEl.appendChild(optionEl);
             }
        }
        // Function Call
        populateSelect(mountainSelectEl, mountainsArray);

        // Event handler for Mountain Select El onchage event
        mountainSelectEl.onchange = () => {
            // Get the selected value from the Mountain Select Element
